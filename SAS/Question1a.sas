...
/* This code attempts to answer question 1:
	Kobe’s shooting percentage is subject to a home field advantage.  
	That is, Kobe’s shooting percentage is better or worse at home than when he is away. */
...
/* Last thing to look at is performing a t-test on the home and away numbers to see if they are significantly different. 
	Have some confidence intervals for each shooting percentage. */
